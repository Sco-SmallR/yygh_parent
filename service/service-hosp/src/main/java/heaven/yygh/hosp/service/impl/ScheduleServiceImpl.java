...
import heaven.yygh.hosp.mapper.ScheduleMapper;
import heaven.yygh.hosp.respository.ScheduleRepository;
 ...
 * @Author: SmallRong
 * @Description:
 * @Date: Created in 10:14 2022/4/10
 * @Modified By:
 */
@Service
public class ScheduleServiceImpl extends ServiceImpl<ScheduleMapper,Schedule> implements ScheduleService {
    ...
    public List<Schedule> getDetailSchedule(String hoscode, String depcode, String workDate) {
        ...
        scheduleList.stream().forEach(item -> {// lamda表达式
