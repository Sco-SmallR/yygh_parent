package heaven.yygh.user.service.impl;
...
import heaven.yygh.enums.AuthStatusEnum;
import heaven.yygh.model.user.Patient;
import heaven.yygh.model.user.UserInfo;
import heaven.yygh.user.mapper.UserInfoMapper;
import heaven.yygh.user.service.PatientService;
 ...
 * @Author: SmallRong
 * @Description:
 * @Date: Created in 10:11 2022/4/15
 * @Modified By:
 */
@Service
public class UserInfoServiceImpl extends
    ...
    public Map<String, Object> loginUser(LoginVo loginVo) {
        ...
        //TODO 校验校验验证码 判断手机验证码和输入的验证码是否一致
        //校验校验验证码
